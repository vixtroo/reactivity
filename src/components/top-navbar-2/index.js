        ...
        <div className="flex flex-wrap content-center justify-center h-24 nav2-container nav-container">
            <div className="flex flex-wrap justify-between w-3/4">
                <div className="flex">
                    ...
                    <div className="flex flex-col flex-wrap content-center pt-2.5 pl-2">
                        ...
                        <div className="flex flex-wrap content-center h-6 font-bold top-navbar2-links mt-3.5">
                ...
                <div className="pt-5">
                    <Formik>
                        <Form>
                            <div className='flex h-6 rounded-sm'>
